...
config :dala, DalaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DalaWeb.ErrorHTML, json: DalaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Dala.PubSub,
  live_view: [signing_salt: "rEmOLwSL"]
...
config :esbuild,
  ...
  dala: [
    args:
      ~w(js/index.tsx js/app.js js/theme.js --bundle --target=es2022 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --alias:@=. --splitting --format=esm),
